...
void Collider::addObject(float centerX, float centerY, float centerZ, float cubeSize) {
    Object newObject;
...
bool Collider::hasCollition(float centerX, float centerY, float centerZ, float cubeSize) {
    float c;
